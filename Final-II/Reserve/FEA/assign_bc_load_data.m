...
% NDOFT : Used to connect local to global DOfs for assembly purposes 
% nieq: Number of identified boundary conditions 
% neq: Length of the unknowns displacement vector 
% nneq: Total Number of the dofs. Length of the displacement vector
% fd: Given force 
